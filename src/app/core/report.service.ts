...
export class ReportService implements OnInit {
  ...
  usersActivationReport(issueOfEquipmentModel: IssueOfEquipmentFormModel): Observable<any> {
    return this.http.post('/api/Report/usersActivationReport', issueOfEquipmentModel);
  }
}
